...
action_agent_response = action_agent.extract_steps_from_prompt("One morning I wanted to have scrambled eggs")

print("Response to 'One morning I wanted to have scrambled eggs':")
